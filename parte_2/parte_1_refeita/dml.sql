 ...
 * Planilhas
 *
 * Não é mais necessário pois a planilha é criada automaticamente
 */
 ...
 * Documentos de texto
 *
 * Não é mais necessário pois o documento de texto é criado automaticamente
 */
 ...
 * Formulários
 *
 * Não é mais necessário pois o formulário é criado automaticamente
 */
...
-- Será dado como erro pelo gatilho, pois a data limite foi ultrapassada
UPDATE formulario SET data_limite = DATE('2023-01-01') WHERE id_documento = 4;
 ...
 * Apresentações
 *
 * Não é mais necessário pois a apresentação é criada automaticamente
 */
